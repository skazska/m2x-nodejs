...
Devices.prototype.bySerial = function(id, callback) {
    return this.client.get(helpers.url("/devices/serial/%s", id), callback);
};
...
// Return a list of the associated triggers for the supplied device
//
// https://m2x.att.com/developer/documentation/v2/triggers#List-Triggers
...
// Create trigger
//
//https://m2x.att.com/developer/documentation/v2/triggers#Create-Trigger
Devices.prototype.createTrigger = function(id, params, callback) {
    ...
    return this.client.post(
      helpers.url("/devices/%s/triggers", id),
      { params: params },
      callback
    );
};
...
// Update trigger
//
//https://m2x.att.com/developer/documentation/v2/triggers#Update-Trigger
...
// Return the details of the supplied trigger
//
// https://m2x.att.com/developer/documentation/v2/triggers#View-Trigger
Devices.prototype.viewTrigger = function(id, triggerId, callback) {
    return this.client.get(helpers.url("/devices/%s/triggers/%s", id, triggerId), callback);
};

// Delete trigger
//
//https://m2x.att.com/developer/documentation/v2/triggers#Delete-Trigger
Devices.prototype.deleteTrigger = function(id, triggerId, params, callback) {
    if (typeof params === "function") {
        callback = params;
        params = {};
    }
...
// Return device's triggers log
//
// https://m2x.att.com/developer/documentation/v2/triggers#View-Triggers-Log
Devices.prototype.viewTriggerLog = function(id, callback) {
    return this.client.get(helpers.url("/devices/%s/triggers/log", id), callback);
};

// trigger test
//
//https://m2x.att.com/developer/documentation/v2/triggers#Test-Trigger
Devices.prototype.testTrigger = function(id, triggerId, params, callback) {
    if (typeof params === "function") {
        callback = params;
        params = {};
    }
    ...
    return this.client.post(
      helpers.url("/devices/%s/triggers/%s/test", id, triggerId),
      { params: params },
      callback
    );
};
